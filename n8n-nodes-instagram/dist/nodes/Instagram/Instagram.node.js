            ...
            try {
                ...
                for (let attempt = 1; attempt <= maxPollAttempts; attempt++) {
                    ...
                    if (statusResponse.status_code === 'ERROR') {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Media container returned status ERROR while waiting to publish.', { itemIndex });
                    }
                    await sleep(pollIntervalMs);
                }
                if (!containerReady) {
                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Timed out waiting for media container to become ready.', { itemIndex });
                }
